...
class CeleriteSystem(NamedTuple):
    a: Array
    U: Array
    V: Array
    P: Array
...
class Term:
    ...
    def get_celerite_matrices(
        self, x: Array, diag: Optional[Array] = None
    ) -> CeleriteSystem:
    ...
    def get_value(self, tau: Array) -> Array:
    ...
    def get_psd(self, omega: Array) -> Array:
    ...
    def dot(self, x: Array, diag: Array, y: Array) -> Array:
...
class TermSum(Term):
    ...
    def get_celerite_matrices(
        ...
        def combine_p(P1: Array, P2: Array) -> Array:
            if P1.ndim == P2.ndim:
...
class RotationTerm(CeleriteTerm):
    ...
    def __init__(
        self, *, sigma: Array, period: Array, Q0: Array, dQ: Array, f: Array
    ):
...
class KalmanTerm(Term):
    def __init__(self, *, sigma: Array, h: Array):
        self.s2 = jnp.square(sigma)
        self.h = h

    def phi(self, dx: Array) -> Array:
...
class Matern32Term(KalmanTerm):
    ...
    def __init__(self, *, sigma: Array, rho: Array):
